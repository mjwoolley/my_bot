> **Vendored from upstream.** This package originates from
> [joshnewans/serial_motor_demo](https://github.com/joshnewans/serial_motor_demo),
> forked at commit `da60760df16b868f2ef487e485e480d28b7d46db`. It is maintained
> in-tree here so it can be modified for this robot; it is no longer synced with
> upstream. Original author: Josh Newans <josh.newans@gmail.com>.
